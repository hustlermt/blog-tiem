        ...
        <div class="row align-items-end">
          <div class="col-md-6">
            <div class="feature-img">
              <img src="img/structure.jpg" alt="Civil Engineering" />
            </div>
          </div>
          <div class="col-md-6">
            ...
            <p>
                We oﬀer services in infrastructural developments which includes the following
            </p>
            <ul class="list-unstyled"> 
                <li> <i class="fas fa-check-circle mr-2"></i> Carry out feasibility studies for proposed urban developments</li>
                <li> <i class="fas fa-check-circle mr-2"></i> Design of sewerage and water reticulation systems</li>
                <li> <i class="fas fa-check-circle mr-2"></i> Water treatment works</li>
                <li> <i class="fas fa-check-circle mr-2"></i> Design of sewerage disposal systems</li>
                <li> <i class="fas fa-check-circle mr-2"></i> Design of roads and storm water drainage</li>
                <li> <i class="fas fa-check-circle mr-2"></i> Supervision of the works during the course of construction</li>
                <li> <i class="fas fa-check-circle mr-2"></i> Preparation of tender documents and adjudication of tenders</li>
            </ul>
