        ...
        <div class="row">
            <div class="col-md-4">
                <div class="gallery-item">
                    <img src="img/civil-engineering.jpg" alt="Tiem Civil And Structural Engineers" class="img-fluid">
                    <div class="image-overlay text-center">
                    <h2 class="image-caption text-uppercase text-white">Harare</h2>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="gallery-item">
                    <img src="img/civil-engineering.jpg" alt="Tiem Civil And Structural Engineers" class="img-fluid">
                    <div class="image-overlay text-center">
                    <h2 class="image-caption text-uppercase text-white">Bulawayo</h2>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="gallery-item">
                    <img src="img/civil-engineering.jpg" alt="Tiem Civil And Structural Engineers" class="img-fluid">
                    <div class="image-overlay text-center">
                    <h2 class="image-caption text-uppercase text-white">Namibia</h2>
                    </div>
                </div>
            </div>
        </div>
